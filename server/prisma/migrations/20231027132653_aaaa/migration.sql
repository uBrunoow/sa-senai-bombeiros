/*
  ...
  - You are about to drop the column `perfusion` on the `Report` table. All the data in the column will be lost.
  ...
  - You are about to drop the `trauma` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "CinematicAvaliation" DROP CONSTRAINT "CinematicAvaliation_ReportOwnerId_fkey";
...
-- DropForeignKey
ALTER TABLE "trauma" DROP CONSTRAINT "trauma_ReportOwnerId_fkey";

-- AlterTable
ALTER TABLE "Report" DROP COLUMN "perfusion",
...
-- DropEnum
DROP TYPE "localTraumaFace";

-- DropEnum
DROP TYPE "localTraumaSide";

-- DropEnum
DROP TYPE "localTraumasBodyPart";
